...
function UpdateMyThreadsButton({ thread, userId }) {
  ...
  const update = async () => {
    ...
    try {
      ...
      reloadMyThreads(userId); // ここでデータ編集したら一覧取得を再読み込みをしてる
...
export default UpdateMyThreadsButton;
